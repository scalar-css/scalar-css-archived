...
/**
 * This plugin reads through all of the font settings in the config passed
 * originally and generates a set of base font rule settings accordingly
 *
 * @param {Object} ctx our project's context object
 */
