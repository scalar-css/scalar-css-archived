...
Note that while the CDN build is large _({{ $page['stats']['default.config.js'][3] }}, {{ $page['stats']['default.config.js'][0] }} raw)_, **it's not representative of the sizes you see when including Tailwind as part of your build process**.
